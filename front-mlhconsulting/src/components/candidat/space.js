...
class Space extends React.Component {
  ...
  submitHandler = (event) => {
    ...
    event.target.name += ' was-validated'
    ...
    axios.put(`http://localhost:3001/auth/signup/:`, candidat)
      .then(response => {
        ...
        <MDBRow className="mt-6">
          <MDBCol md="">
            <form className='needs-validation' onSubmit={this.submitHandler} noValidate>
              ...
              <MDBBtn className="btn btn-unique" outline gradient='blue' type="submit">Submit Form</MDBBtn>
            </form>
          </MDBCol>
        </MDBRow>
      </MDBContainer>
