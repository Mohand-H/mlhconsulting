    ...
    return (
      <div className="container-fluid">
        ...
        <MDBRow>
          ...
          <MDBCol size='12' sm='6' >
            <img src='./pictures/vosbesoins_ameliorervos_pratique_de_test.jpg' className="img-fluid" alt="Responsive image" />
          </MDBCol>
         
          <MDBCol size='12' sm='6'>
            <h1>Améliorer vos pratique de Test</h1>
            <p>Avec l’amplification des rythmes d’évolution des systèmes d’information, les besoins de test logiciel augmentent en volume et se complexifient de plus en plus : tests unitaire, test d’intégration, qualification et recette, test agile, test de non-régression, test des web services, test des applications mobiles, test transverse inter-applicatif… Afin de faire face à cette complexité croissante, les entreprises doivent s’organiser en conséquence et adopter des méthodes, les processus et les outils de test pour rationaliser, professionnaliser et industrialiser leurs activités de test.</p>

            <h1>Quelle stratégie adopter ? </h1>
            <p>Quel niveau de maturité de notre organisation en matière de test logiciel par rapport à l’état de l’art du marché ?
        ...
        <MDBRow>
          <MDBCol size='12' sm='6'>
            ...
            <p>Durant le processus d’évolution d’un système d’information, le volume de test à faire de chaque release augmente au fil du temps.
          ...
          <MDBCol size='12' sm='6'>
            <img src='./pictures/vosbesoins_automatiservostests.jpg' className="img-fluid" alt="Responsive image" />
          </MDBCol>
        </MDBRow>

        <MDBRow>
          <MDBCol size='12' sm='6'>
              <img src='./pictures/vosbesoins-externaliservostests.jpg' className="img-fluid" alt="#" />
          </MDBCol>

          <MDBCol size='12' sm='6'>
            <h1>Externaliser vos tests</h1>
            <p>Pour les équipes MOA et les équipes de DSI, la prise en charge des activités de test peut représenter une charge importante avec une complexité croissante à gérer au fil du temps.</p>
            <p>L’externalisation des activités de test peut être envisagée :</p>
            <ul>
            ...
            <p>Découvrez nos solutions Tierce recette Applicative</p>
            <ul>
