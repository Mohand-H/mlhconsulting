      ...
      <div className="container-fluid">
        <MDBRow className="section-1">
          ...
          <View className="rounded z-depth-2 mb-lg-0 mb-4" hover waves>
            <img className='img-fluid' src='./pictures/vosbesoins_ameliorervos_pratique_de_test.jpg' alt="Responsive image"/>
        ...
        <MDBRow className="section-2">
          ...
          <MDBCol size='12' sm='6'>
          <View className="rounded z-depth-2 mb-lg-0 mb-4" hover waves>
            <img className="img-fluid"  src='./pictures/vosbesoins_automatiservostests.jpg' alt="Responsive image" />
            <a><Mask overlay="white-slight"/></a>
          </View>
          </MDBCol>
        </MDBRow>
        ...
        <MDBRow className="section-3">
          <MDBCol size='12' sm='6'>
          <View className="rounded z-depth-2 mb-lg-0 mb-4" hover waves>
              <img className="img-fluid" src='./pictures/vosbesoins-externaliservostests.jpg' alt="Responsive image" />
              <a><Mask overlay="white-slight"/></a>
          </View>
          </MDBCol>
        ...
        <MDBRow className="section-4">
          ...
          <MDBCol size='12' sm='6'>
          <View className="rounded z-depth-2 mb-lg-0 mb-4" hover waves>
              <img className='img-fluid' src="./pictures/vosbesoins-tester_vos_app.jpg" alt="Responsive image" />
              <a><Mask overlay="white-slight"/></a>
          </View>
          </MDBCol>
        </MDBRow>
