...
import { MDBRow, MDBCol, Button, View, Mask, MDBContainer} from 'mdbreact'
            ...
            <div className="container-fluid">
                <MDBRow className="section-1">
                    <MDBCol>
                        <View className="rounded z-depth-2 mb-lg-0 mb-4" hover waves>
                            <img className="img-fluid" src='./pictures/nossolutios_batirvotrestrategie.jpg' className="img-fluid" alt="Responsive image" />
                ...
                <MDBRow className="section-2">
                    <MDBCol>
                        ...
                        <View className="rounded z-depth-2 mb-lg-0 mb-4" hover waves>
                            <img className='img-fluid' src='./pictures/nossolutions_mettre_en place_un_ref_de_test.png' alt="Responsive image" />
                            <a><Mask overlay="white-slight"/></a>
                        </View>
                    </MDBCol>
                    <MDBCol >
                ...
                <MDBCol>
                    <View className="rounded z-depth-2 mb-lg-0 mb-4" hover waves>
                        <img className="img-fluid" src='./pictures/nossolutions_testervosapplications.png'  alt="Responsive image" />
                        <a><Mask overlay="white-slight"/></a>
                    </View>
                    </MDBCol>
                    <MDBCol>
                ...
                <MDBRow className="section-4">
                    ...
                    <MDBCol>
                    <View className="rounded z-depth-2 mb-lg-0 mb-4" hover waves>
                        <img className="img-fluid" src='./pictures/nossolutions_automatisationdestests.png'  alt="Responsive image" />
                        <a><Mask overlay="white-slight"/></a>
                    </View>
                    </MDBCol>
                </MDBRow>
