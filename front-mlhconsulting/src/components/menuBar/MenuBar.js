...
class MenuBar extends Component {
  ...
  render() {
    return (
      ...
      <Navbar dark expand="md" style={{ marginTop: "0px" }} >
        <NavbarBrand>
          <img src='./pictures/accueil_Bonhommeloupe.png' style={{ width: '150px' }} />
        </NavbarBrand>
        ...
        <Collapse id="navbarCollapse3" isOpen={this.state.collapseID} navbar>
          <NavbarNav  right>
            ...
            <NavItem>
              ...
              <NavLink style={{ color: 'black' }} className="candidat" to="candidat">Espace candidat</NavLink>
            </NavItem>
          </NavbarNav>
        </Collapse>
      </Navbar>
